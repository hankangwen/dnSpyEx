...
namespace dnSpy.Text.Editor {
	...
	sealed class HorizontalScrollBarMargin : DsScrollBar, IWpfTextViewMargin {
		...
		void UpdateMaximum() => Maximum = IsWordWrap ? 0 : Math.Max(wpfTextViewHost.TextView.ViewportLeft, Math.Max(wpfTextViewHost.TextView.MaxTextRightCoordinate, wpfTextViewHost.TextView.Caret.Right) - wpfTextViewHost.TextView.ViewportWidth + WpfTextViewConstants.EXTRA_HORIZONTAL_SCROLLBAR_WIDTH);
